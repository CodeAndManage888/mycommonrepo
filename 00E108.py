...
# be displayed in the same order that they were entered This  *
# copy belongs to 'acha04'Exercise 108: Negatives, Zeros and  *
# Positives 51 by the user. For example, if the user enters   *
# the values 3, -4, 1, 0,-1, 0, and-2 then your program       *
# should output the values -4,-1,-2, 0, 0, 3, and 1. Your     *
