...
# "don’t","isn’t","and","wouldn’t"] . This copy belongs to    *
# 'acha04'52 5 List Exercises Write a main program that       *
# demonstrates your function. It should read a string from    *
# the user and display all of the words in the string with    *
# the punctuation marks removed. You will need to import your *
# solution to this exercise when completing Exercise 158. As  *
# a result, you should ensure that your main program only     *
