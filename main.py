...
# that removes all of the comments from a Python source ﬁle.  *
# Check each line in the ﬁle to determine if a #character is  *
...
# occurs inside of a string). Save the modiﬁed ﬁle using a    *
# new name that will be entered by the user. The user will    *
# also enter the name of the input ﬁle. Ensure that an        *
