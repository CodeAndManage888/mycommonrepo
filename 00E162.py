...
# making them difﬁcult to read, or they might be too short   *
# and fail to make use of the available space. Write a       *
# program that opens a ﬁle and displays it so that each line *
# is ﬁlled as full as possible. If you read a line that is   *
...
# the ﬁle to ﬁnish ﬁlling the current line of output. For    *
# example, consider a ﬁle containing the following lines from*
