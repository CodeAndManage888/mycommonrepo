...
#                                                             *
# When completing this exercise you will probably find it     *
# helpful to be able to print out a value without moving down *
# the next line. This can be accomplished by added end="" as  *
# the last parameter to you print statement. For example,     *
# print("A", end="") will display the letter A without moving *
# down to the next line, causing the next print statement to  *
# display its result on the same line as the letter A.        *
#                                                             *
