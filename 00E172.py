...
# function to ﬁnd the longest sequence of elements that      *
...
# It may take your program up to two minutes to ﬁnd the      *
# longest sequence for some elements. As a result, you might *
# want to use elements like Molyb- denum and Magnesium as    *
# your ﬁrst test cases. Each has a longest sequence that is  *
# only 8 elements long which your program should ﬁnd in a    *
