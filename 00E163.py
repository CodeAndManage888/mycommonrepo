...
# contains each of the vowels a,e,i,o,uandyexactly once and  *
# in order. Write a program that searches a ﬁle containing a *
# list of words and displays all of the words that meet this *
# constraint. The user will provide the name of the ﬁle that *
# will be searched. Display an appropriate error message and *
# exit the program if the user provides an invalid ﬁle name  *
