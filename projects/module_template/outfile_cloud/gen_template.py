...
# that can be effec- tive when repeated values occur at      *
# adjacent positions within a list. Compression is This copy *
# belongs to 'acha04'84 8 Recursion Exercises achieved by    *
