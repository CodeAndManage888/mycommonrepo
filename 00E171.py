...
# can be spelled using This copy belongs to 'acha04'Exercise *
# 171: Spelling with Element Symbols 83 the symbols Si, Li,  *
# C, O and N. However, hydrogen can not be spelled with any  *
# combination of element symbols. Write a recursive function *
# that determines whether or not a word can be spelled using *
# only element symbols. Your function will take two          *
# parameters: the word that you are trying to spell and a    *
# list of the symbols that can be used. Your function will   *
# return two results: a Boolean value indicating whether or  *
# not a spelling was found, and the string of symbols used to*
...
# names of the ele- ments along with the sequences of        *
