...
# an operator, or a number with an optional leading +or-(for  *
# simplicity we will only work with integers in this          *
...
# consisting of parentheses, operators and integers. How-     *
# ever, your function must handle variable amounts of         *
# whitespace between these elements. Include a main program   *
# that demonstrates your tokenizing function by reading an    *
# expression from the user and printing the list of tokens.   *
# Ensure that the This copy belongs to 'acha04'Exercise       *
# 122:Tokenizing a String 57 main program will not run when   *
# the ﬁle containing your solution is imported into another   *
# program.                                                    *
#                                                             *
